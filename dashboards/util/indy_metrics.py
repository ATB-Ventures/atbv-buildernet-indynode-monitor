...
def _get_metrics_live(GENESIS_URL, SEED):
    try:
        ...
        my_env["SEED"] = SEED  
        proc = subprocess.Popen(["/home/indymonitor/github/atbv-buildernet-indynode-monitor/fetch-validator-status/run.sh"],env=my_env,cwd=r'/home/indymonitor/github/atbv-buildernet-indynode-monitor/fetch-validator-status',stdout=subprocess.PIPE,stderr=subprocess.PIPE)
